...
while running:
    ...
    #Brick collision
    for brick in brick_list:
    	  #brick_particles.append([[brick.centerx, brick.centery], [random.randint(0, 5) / 10 - 1, -2], random.randint(0, 20)])
    		if ball.colliderect(brick):
    			brick_particles.append([[brick.centerx, brick.centery], [random.randint(0, 5) / 10 - 1, -8], random.randint(0, 20)])
