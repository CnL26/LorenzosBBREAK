#Shout out to Pyguru for mad inspiration and understanding!!!
#$hout out to Dafluffypotato for particle system!!!
...
bg_anim_clr = (YELLOW, SILVER, GOLD, WHITE, ORANGE, GRAY)
...
#*****Update*************************! 
    ...
    def show_gw():
        ...
        while win:
        	...
        	pygame.mixer.music.load('HipHopNoir_1.wav')
        	pygame.mixer.music.play(-1)
        	screen.blit(font.render('YOU WIN!!!', True, WHITE), (300, 1000))
        	pygame.display.flip()
